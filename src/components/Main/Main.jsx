                    ...
                    <div className="chat w-[95%] lg:w-[700px] h-full flex flex-col gap-8 ">
                        ...
                        (<>
                            ...
                            <div className="output justify-start flex w-[95%]">
                                <img className="h-[35px]" src="/google-gemini-logo-removebg-preview.png" alt="logo" />
                    ...
                    <div className="user-input mx-2 w-[350px] md:w-[40%] md:min-w-[550px] border border-[#4a5050] rounded-[22px] flex flex-col gap-1.5 h-fit px-2 pb-2 pt-3">
                        ...
                        <div className="flex justify-between">
                            <div className="w-full flex gap-2">
                                ...
                                <div className="deep-research flex items-center gap-2 py-2 px-3 hover:bg-[#323537] cursor-pointer rounded-full">
                                    <svg className="w-[20px] hidden md:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <div className="canvas flex items-center gap-2 py-2 px-3 hover:bg-[#323537] cursor-pointer rounded-full">
                                    <svg className="w-[20px] hidden md:block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" >
